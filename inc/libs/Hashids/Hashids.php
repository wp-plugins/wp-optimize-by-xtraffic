...
//include_once(realpath(dirname(__FILE__).'/./HashGenerator.php'));


if ( !class_exists('PepVN_Hashids') ) :

interface PepVN_HashGenerator {
...
class PepVN_Hashids implements PepVN_HashGenerator 
{
