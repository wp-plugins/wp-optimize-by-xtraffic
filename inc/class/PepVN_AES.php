...
class PepVN_AESCtr extends PepVN_AES {
    ...
    public static function encrypt($plaintext, $password, $nBits) {
        ...
        $key = PepVN_AES::cipher($pwBytes, PepVN_AES::keyExpansion($pwBytes));
        ...
        $keySchedule = PepVN_AES::keyExpansion($key);
        //print_r($keySchedule);
        ...
        for ($b=0; $b<$blockCount; $b++) {
            ...
            $cipherCntr = PepVN_AES::cipher($counterBlock, $keySchedule);  // -- encrypt counter block --
